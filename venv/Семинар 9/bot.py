...
from handlers.play_2021 import input_player_name_handler, input_player_age_handler, PLAYER_NAME_STATE, \
...
TOKEN = "5751729812:AAEujWqDxpeMGNN5GbptnSKZEVaVGqVUR6E"
...
def main() -> None:
    ...
    player_profile_conv_handler = ConversationHandler(
        entry_points=[CommandHandler('play_2021', play_2021_command)],
        states={
